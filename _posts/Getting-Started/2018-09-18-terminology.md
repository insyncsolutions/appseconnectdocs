...
|***View Snapshot***|Snapshot in workflow gives complete overview of the sync process that is implemented. Snapshot provide the users with the detailed results of the data  that was transferred through workflow|
