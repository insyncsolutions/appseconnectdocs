...
API hits can be tamed using action filters on its actions. You will be able to fetch specific and limited data as per your filter. With APPSeCONNECT, you will have the option to implement 
